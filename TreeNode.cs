...
namespace Template_P3
{
    public class TreeNode
    {
        ...
        public TreeNode(TreeNode parent, Mesh mesh = null, Texture texture = null)
        {
        ...
        public void TreeNodeRender(Matrix4 ouder, Shader shader, Matrix4 worldTransform, Vector4[] lightData)
        {
            //Het object in de TreeNode is een mesh.
            if (treeNodeMesh != null)
                treeNodeMesh.Render(shader, ouder, worldTransform, treeNodeTexture, lightData);
            ...
            for (int i = 0; i < treeNodeChildren.Count; i++)
            {
                ...
                matrix = treeNodeChildren[i].treeNodeMesh.meshTransform * ouder;
                //Uitkomst Matrix4 doorgeven aan kind.
                treeNodeChildren[i].TreeNodeRender(matrix, shader, worldTransform, lightData);
            }
